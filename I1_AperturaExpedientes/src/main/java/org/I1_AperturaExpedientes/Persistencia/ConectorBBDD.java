...
public class ConectorBBDD {
	...
	/**
	 * Metodo que devuelve un array con los datos de los expedientes que aun no han sido sancionados
	 * @return
	 */
	...
	/**
	 * Metodo que pasado un conductor, comprueba que ese conductor esta en la bbdd
	 * @param c
	 * @return
	 */
	...
	public void insertarSancion(Sancion s) {
		try{
			...
			String consulta = "INSERT INTO sanciones VALUES (DEFAULT,'"+s.getCon().getDni()+"', "+s.getExpediente()+", "+s.getImporte()+", "+s.getPuntosrestar()+" ,"+pag+")";			
			st.executeUpdate(consulta);
	...
	/**
	 * Metodo que devuelve un objeto Expediente buscado en la bbdd por su identificador
	 * @param id
	 * @return
	 */
	...
	/**
	 * Metodo que devuelve un objeto Vehiculo buscado en la bbdd por su matricula
	 * @param matricula
	 * @return
	 */
	...
	/**
	 * Metodo que devuelve un objeto Radar buscado en la bbdd por su identificador
	 * @param id
	 * @return
	 */
	...
	/**
	 * Metodo que devuelve un objeto Conductor buscado en la base de datos por su dni
	 * @param dniConductor
	 * @return
	 */
